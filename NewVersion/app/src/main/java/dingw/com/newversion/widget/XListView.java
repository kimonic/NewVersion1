package dingw.com.newversion.widget;
...
public class XListView extends ListView implements OnScrollListener {
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if (!mIsFooterReady) {
            ...
            mFooterView.hide();//将footer view添加后隐藏
    ...
    public void autoRefresh() {
        ...
        if (mEnablePullRefresh && !mPullRefreshing) {
            ...
            if (mHeader.getVisibleHeight() > mHeaderHeight) {
                mHeader.setState(XHeaderView.STATE_READY);//下拉大于header view的高度时,设置状态为已准备好加载状态,即松开后刷新
            } else {
    ...
    private void resetHeaderHeight() {
        ...
        //当headerview的下拉显示高度小于正常显示高度时,什么也不做
